...
public class min2table2admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r10 = FirebaseDatabase.getInstance().getReference().child("co1 L2");r20 = FirebaseDatabase.getInstance().getReference().child("co2 L2");
        r30 = FirebaseDatabase.getInstance().getReference().child("co3 L2");r40 = FirebaseDatabase.getInstance().getReference().child("co4 L2");
        r50 = FirebaseDatabase.getInstance().getReference().child("co5 L2");r60 = FirebaseDatabase.getInstance().getReference().child("co6 L2");
        r70 = FirebaseDatabase.getInstance().getReference().child("co7 L2");r80 = FirebaseDatabase.getInstance().getReference().child("co8 L2");
        r90 = FirebaseDatabase.getInstance().getReference().child("co9 L2");r11 = FirebaseDatabase.getInstance().getReference().child("co10 L2");
        r21 = FirebaseDatabase.getInstance().getReference().child("co11 L2");r31 = FirebaseDatabase.getInstance().getReference().child("co12 L2");
        r41 = FirebaseDatabase.getInstance().getReference().child("co13 L2");r51 = FirebaseDatabase.getInstance().getReference().child("co14 L2");
        r61 = FirebaseDatabase.getInstance().getReference().child("co15 L2");r71 = FirebaseDatabase.getInstance().getReference().child("co16 L2");
        r81 = FirebaseDatabase.getInstance().getReference().child("co17 L2");r91 = FirebaseDatabase.getInstance().getReference().child("co18 L2");
        r92 = FirebaseDatabase.getInstance().getReference().child("co19 L2");r93 = FirebaseDatabase.getInstance().getReference().child("co20 L2");
        r94 = FirebaseDatabase.getInstance().getReference().child("co21 L2");
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(min2table2admin.this,"Table Uploded well",Toast.LENGTH_LONG).show();
