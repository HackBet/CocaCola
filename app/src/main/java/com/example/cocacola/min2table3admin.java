...
public class min2table3admin extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            r10 = FirebaseDatabase.getInstance().getReference().child("co1 L3");r20 = FirebaseDatabase.getInstance().getReference().child("co2 L3");
            r30 = FirebaseDatabase.getInstance().getReference().child("co3 L3");r40 = FirebaseDatabase.getInstance().getReference().child("co4 L3");
            r50 = FirebaseDatabase.getInstance().getReference().child("co5 L3");r60 = FirebaseDatabase.getInstance().getReference().child("co6 L3");
            r70 = FirebaseDatabase.getInstance().getReference().child("co7 L3");r80 = FirebaseDatabase.getInstance().getReference().child("co8 L3");
            r90 = FirebaseDatabase.getInstance().getReference().child("co9 L3");r11 = FirebaseDatabase.getInstance().getReference().child("co10 L3");
            r21 = FirebaseDatabase.getInstance().getReference().child("co11 L3");r31 = FirebaseDatabase.getInstance().getReference().child("co12 L3");
            r41 = FirebaseDatabase.getInstance().getReference().child("co13 L3");r51 = FirebaseDatabase.getInstance().getReference().child("co14 L3");
            r61 = FirebaseDatabase.getInstance().getReference().child("co15 L3");r71 = FirebaseDatabase.getInstance().getReference().child("co16 L3");
            r81 = FirebaseDatabase.getInstance().getReference().child("co17 L3");r91 = FirebaseDatabase.getInstance().getReference().child("co18 L3");
            r92 = FirebaseDatabase.getInstance().getReference().child("co19 L3");r93 = FirebaseDatabase.getInstance().getReference().child("co20 L3");
            r94 = FirebaseDatabase.getInstance().getReference().child("co21 L3");
            b1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText( min2table3admin.this,"Table Uploded well",Toast.LENGTH_LONG).show();
