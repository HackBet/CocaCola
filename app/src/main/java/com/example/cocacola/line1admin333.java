...
public class line1admin333 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line1admin333);
        ...
        d34 = FirebaseDatabase.getInstance().getReference("Production Plan L1");
        d44 = FirebaseDatabase.getInstance().getReference("Quality Deviations L1");
        d54 = FirebaseDatabase.getInstance().getReference("Accidents, Incidents L1");
        d64 = FirebaseDatabase.getInstance().getReference("Absenteeism L1");
        d74 = FirebaseDatabase.getInstance().getReference("Stoppage Sheets Collected L1");
        d84 = FirebaseDatabase.getInstance().getReference("Actual Captured L1");
        d94 = FirebaseDatabase.getInstance().getReference(" Feedback L1");
        d10 =FirebaseDatabase.getInstance().getReference("Shift L1");
        d12 =FirebaseDatabase.getInstance().getReference("Admin Name L1");
