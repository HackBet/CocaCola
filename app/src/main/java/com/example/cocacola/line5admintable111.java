...
public class line5admintable111 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line5admintable111);
        ...
        r10 = FirebaseDatabase.getInstance().getReference().child("firstrow L5");
        r20 = FirebaseDatabase.getInstance().getReference().child("secondrow L5");
        r30 = FirebaseDatabase.getInstance().getReference().child("thirdrow L5");;
        r40 = FirebaseDatabase.getInstance().getReference().child("forthrow L5");
        r50 = FirebaseDatabase.getInstance().getReference().child("fifthrow L5");
        r60 = FirebaseDatabase.getInstance().getReference().child("Sixthrow L5");
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(line5admintable111.this,"Table Uploded well",Toast.LENGTH_LONG).show();
            }
        });
