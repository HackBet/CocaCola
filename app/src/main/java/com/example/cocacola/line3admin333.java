...
public class line3admin333 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line3admin333);
        ...
        d34 = FirebaseDatabase.getInstance().getReference("Production Plan L3");
        d44 = FirebaseDatabase.getInstance().getReference("Quality Deviations L3");
        d54 = FirebaseDatabase.getInstance().getReference("Accidents, Incidents L3");
        d64 = FirebaseDatabase.getInstance().getReference("Absenteeism L3");
        d74 = FirebaseDatabase.getInstance().getReference("Stoppage Sheets Collected L3");
        d84 = FirebaseDatabase.getInstance().getReference("Actual Captured L3");
        d94 = FirebaseDatabase.getInstance().getReference(" Feedback L3");
        d10 =FirebaseDatabase.getInstance().getReference("Shift L3");
        d12 =FirebaseDatabase.getInstance().getReference("Admin Name L3");
