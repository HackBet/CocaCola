...
public class line6admin222 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line6admin222);
        ...
        d9 = FirebaseDatabase.getInstance().getReference().child("Shift M2L6");
        d10 = FirebaseDatabase.getInstance().getReference().child("Admin Name M2L6");
        database = FirebaseDatabase.getInstance().getReference().child("Work Practice L6");
        d2 = FirebaseDatabase.getInstance().getReference().child("General Comment L6");
        ...
        bt2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), min2table6admin.class));
            }
        });
