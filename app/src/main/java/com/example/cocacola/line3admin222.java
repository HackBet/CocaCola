...
public class line3admin222 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line3admin222);
        ...
        d9 = FirebaseDatabase.getInstance().getReference().child("Shift M2L3");
        d10 = FirebaseDatabase.getInstance().getReference().child("Admin Name M2L3");
        database = FirebaseDatabase.getInstance().getReference().child("Work Practice L3");
        d2 = FirebaseDatabase.getInstance().getReference().child("General Comment L3");
        ...
        bt2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), min2table3admin.class));
            }
        });
