...
import com.example.cocacola.Adapters.MessageAdapter;
import com.example.cocacola.models.AllMethods;
import com.example.cocacola.models.Message;
...
public class Announcement extends AppCompatActivity implements View.OnClickListener {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId()==R.id.menuLogout)
        {
            auth.signOut();
            finish();
            startActivity(new Intent(Announcement.this, Main2Activity.class));
