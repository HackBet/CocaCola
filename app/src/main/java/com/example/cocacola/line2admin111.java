...
public class line2admin111 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line2admin111);
        ...
        database = FirebaseDatabase.getInstance().getReference().child("Attendance L2");
        d2 = FirebaseDatabase.getInstance().getReference().child("Safety L2");
        d3 = FirebaseDatabase.getInstance().getReference().child("Previous Day's Action L2");
        // d4 = FirebaseDatabase.getInstance().getReference().child("Review Of Past Performance L1");
        d5 = FirebaseDatabase.getInstance().getReference().child("Today Production plan L2");
        d6 = FirebaseDatabase.getInstance().getReference().child("Today's Action Plan L2");
        d7 = FirebaseDatabase.getInstance().getReference().child("General Communication L2");
        d8 = FirebaseDatabase.getInstance().getReference().child("Issues for escalation L2");
        d9 = FirebaseDatabase.getInstance().getReference().child("Shift L2");
        d10 = FirebaseDatabase.getInstance().getReference().child("Admin Name L2");
...
// et4 = (EditText)findViewById(R.id.b40);
        ...
        */
        bt4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),line2admintable111.class));
            }
        });
