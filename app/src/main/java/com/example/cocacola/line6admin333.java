...
public class line6admin333 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line6admin333);
        ...
        d34 = FirebaseDatabase.getInstance().getReference("Production Plan L6");
        d44 = FirebaseDatabase.getInstance().getReference("Quality Deviations L6");
        d54 = FirebaseDatabase.getInstance().getReference("Accidents, Incidents L6");
        d64 = FirebaseDatabase.getInstance().getReference("Absenteeism L6");
        d74 = FirebaseDatabase.getInstance().getReference("Stoppage Sheets Collected L6");
        d84 = FirebaseDatabase.getInstance().getReference("Actual Captured L6");
        d94 = FirebaseDatabase.getInstance().getReference(" Feedback L6");
        d10 =FirebaseDatabase.getInstance().getReference("Shift L6");
        d12 =FirebaseDatabase.getInstance().getReference("Admin Name L6");
