...
public class line6admin111 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line6admin111);
        ...
        database = FirebaseDatabase.getInstance().getReference().child("Attendance L6");
        d2 = FirebaseDatabase.getInstance().getReference().child("Safety L6");
        d3 = FirebaseDatabase.getInstance().getReference().child("Previous Day's Action L6");
        // d4 = FirebaseDatabase.getInstance().getReference().child("Review Of Past Performance L1");
        d5 = FirebaseDatabase.getInstance().getReference().child("Today Production plan L6");
        d6 = FirebaseDatabase.getInstance().getReference().child("Today's Action Plan L6");
        d7 = FirebaseDatabase.getInstance().getReference().child("General Communication L6");
        d8 = FirebaseDatabase.getInstance().getReference().child("Issues for escalation L6");
        d9 = FirebaseDatabase.getInstance().getReference().child("Shift L6");
        d10 = FirebaseDatabase.getInstance().getReference().child("Admin Name L6");
...
// et4 = (EditText)findViewById(R.id.b40);
        ...
        bt4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),line6admintable111.class));
            }
        });
       /* bt4.setOnClickListener(new View.OnClickListener() {
            @Override
