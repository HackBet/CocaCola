...
public class line3admin111 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line3admin111);
        ...
        database = FirebaseDatabase.getInstance().getReference().child("Attendance L3");
        d2 = FirebaseDatabase.getInstance().getReference().child("Safety L3");
        d3 = FirebaseDatabase.getInstance().getReference().child("Previous Day's Action L3");
        // d4 = FirebaseDatabase.getInstance().getReference().child("Review Of Past Performance L1");
        d5 = FirebaseDatabase.getInstance().getReference().child("Today Production plan L3");
        d6 = FirebaseDatabase.getInstance().getReference().child("Today's Action Plan L3");
        d7 = FirebaseDatabase.getInstance().getReference().child("General Communication L3");
        d8 = FirebaseDatabase.getInstance().getReference().child("Issues for escalation L3");
        d9 = FirebaseDatabase.getInstance().getReference().child("Shift L3");
        d10 = FirebaseDatabase.getInstance().getReference().child("Admin Name L3");
...
// et4 = (EditText)findViewById(R.id.b40);
        ...
        */
        bt4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),line3admintable111.class));
            }
        });
