...
public class min2table5admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r10 = FirebaseDatabase.getInstance().getReference().child("co1 L5");r20 = FirebaseDatabase.getInstance().getReference().child("co2 L5");
        r30 = FirebaseDatabase.getInstance().getReference().child("co3 L5");r40 = FirebaseDatabase.getInstance().getReference().child("co4 L5");
        r50 = FirebaseDatabase.getInstance().getReference().child("co5 L5");r60 = FirebaseDatabase.getInstance().getReference().child("co6 L5");
        r70 = FirebaseDatabase.getInstance().getReference().child("co7 L5");r80 = FirebaseDatabase.getInstance().getReference().child("co8 L5");
        r90 = FirebaseDatabase.getInstance().getReference().child("co9 L5");r11 = FirebaseDatabase.getInstance().getReference().child("co10 L5");
        r21 = FirebaseDatabase.getInstance().getReference().child("co11 L5");r31 = FirebaseDatabase.getInstance().getReference().child("co12 L5");
        r41 = FirebaseDatabase.getInstance().getReference().child("co13 L5");r51 = FirebaseDatabase.getInstance().getReference().child("co14 L5");
        r61 = FirebaseDatabase.getInstance().getReference().child("co15 L5");r71 = FirebaseDatabase.getInstance().getReference().child("co16 L5");
        r81 = FirebaseDatabase.getInstance().getReference().child("co17 L5");r91 = FirebaseDatabase.getInstance().getReference().child("co18 L5");
        r92 = FirebaseDatabase.getInstance().getReference().child("co19 L5");r93 = FirebaseDatabase.getInstance().getReference().child("co20 L5");
        r94 = FirebaseDatabase.getInstance().getReference().child("co21 L5");
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText( min2table5admin.this,"Table Uploded well",Toast.LENGTH_LONG).show();
