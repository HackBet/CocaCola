...
public class line1adminmin222 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line1adminmin222);
        ...
        d9 = FirebaseDatabase.getInstance().getReference().child("Shift M2L1");
        d10 = FirebaseDatabase.getInstance().getReference().child("Admin Name M2L1");
        database = FirebaseDatabase.getInstance().getReference().child("Work Practice L1");
        d2 = FirebaseDatabase.getInstance().getReference().child("General Comment L1");
       ...
       // et2 = (EditText)findViewById(R.id.b233);
        ...
        bt2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), Main26Activity.class));
            }
        });
