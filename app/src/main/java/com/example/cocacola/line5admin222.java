...
public class line5admin222 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line5admin222);
        ...
        d9 = FirebaseDatabase.getInstance().getReference().child("Shift M2L5");
        d10 = FirebaseDatabase.getInstance().getReference().child("Admin Name M2L5");
        database = FirebaseDatabase.getInstance().getReference().child("Work Practice L5");
        d2 = FirebaseDatabase.getInstance().getReference().child("General Comment L5");
        ...
        bt2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), min2table5admin.class));
            }
        });
