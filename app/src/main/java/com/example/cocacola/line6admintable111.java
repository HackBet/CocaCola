...
public class line6admintable111 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line6admintable111);
        ...
        r10 = FirebaseDatabase.getInstance().getReference().child("firstrow L6");
        r20 = FirebaseDatabase.getInstance().getReference().child("secondrow L6");
        r30 = FirebaseDatabase.getInstance().getReference().child("thirdrow L6");;
        r40 = FirebaseDatabase.getInstance().getReference().child("forthrow L6");
        r50 = FirebaseDatabase.getInstance().getReference().child("fifthrow L6");
        r60 = FirebaseDatabase.getInstance().getReference().child("Sixthrow L6");
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(line6admintable111.this,"Table Uploded well",Toast.LENGTH_LONG).show();
            }
        });
