...
public class line4admintable111 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line4admintable111);
        ...
        r10 = FirebaseDatabase.getInstance().getReference().child("firstrow L4");
        r20 = FirebaseDatabase.getInstance().getReference().child("secondrow L4");
        r30 = FirebaseDatabase.getInstance().getReference().child("thirdrow L4");;
        r40 = FirebaseDatabase.getInstance().getReference().child("forthrow L4");
        r50 = FirebaseDatabase.getInstance().getReference().child("fifthrow L4");
        r60 = FirebaseDatabase.getInstance().getReference().child("Sixthrow L4");
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(line4admintable111.this,"Table Uploded well",Toast.LENGTH_LONG).show();
            }
        });
