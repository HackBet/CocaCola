...
DatabaseReference r10,r20,r30,r40,r50,r60,r70,r80,r90,r11,r21,r31,r41,r51,r61,r71,r81,r91,r92,r93,r94;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r10 = FirebaseDatabase.getInstance().getReference().child("co1");r20 = FirebaseDatabase.getInstance().getReference().child("co2");
        r30 = FirebaseDatabase.getInstance().getReference().child("co3");r40 = FirebaseDatabase.getInstance().getReference().child("co4");
        r50 = FirebaseDatabase.getInstance().getReference().child("co5");r60 = FirebaseDatabase.getInstance().getReference().child("co6");
        r70 = FirebaseDatabase.getInstance().getReference().child("co7");r80 = FirebaseDatabase.getInstance().getReference().child("co8");
        r90 = FirebaseDatabase.getInstance().getReference().child("co9");r11 = FirebaseDatabase.getInstance().getReference().child("co10");
        r21 = FirebaseDatabase.getInstance().getReference().child("co11");r31 = FirebaseDatabase.getInstance().getReference().child("co12");
        r41 = FirebaseDatabase.getInstance().getReference().child("co13");r51 = FirebaseDatabase.getInstance().getReference().child("co14");
        r61 = FirebaseDatabase.getInstance().getReference().child("co15");r71 = FirebaseDatabase.getInstance().getReference().child("co16");
        r81 = FirebaseDatabase.getInstance().getReference().child("co17");r91 = FirebaseDatabase.getInstance().getReference().child("co18");
        r92 = FirebaseDatabase.getInstance().getReference().child("co19");r93 = FirebaseDatabase.getInstance().getReference().child("co20");
        r94 = FirebaseDatabase.getInstance().getReference().child("co21");
b1.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        ...
        Toast.makeText(Main26Activity.this,"Table Uploded well",Toast.LENGTH_LONG).show();
