...
public class min2table4admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r10 = FirebaseDatabase.getInstance().getReference().child("co1 L4");r20 = FirebaseDatabase.getInstance().getReference().child("co2 L4");
        r30 = FirebaseDatabase.getInstance().getReference().child("co3 L4");r40 = FirebaseDatabase.getInstance().getReference().child("co4 L4");
        r50 = FirebaseDatabase.getInstance().getReference().child("co5 L4");r60 = FirebaseDatabase.getInstance().getReference().child("co6 L4");
        r70 = FirebaseDatabase.getInstance().getReference().child("co7 L4");r80 = FirebaseDatabase.getInstance().getReference().child("co8 L4");
        r90 = FirebaseDatabase.getInstance().getReference().child("co9 L4");r11 = FirebaseDatabase.getInstance().getReference().child("co10 L4");
        r21 = FirebaseDatabase.getInstance().getReference().child("co11 L4");r31 = FirebaseDatabase.getInstance().getReference().child("co12 L4");
        r41 = FirebaseDatabase.getInstance().getReference().child("co13 L4");r51 = FirebaseDatabase.getInstance().getReference().child("co14 L4");
        r61 = FirebaseDatabase.getInstance().getReference().child("co15 L4");r71 = FirebaseDatabase.getInstance().getReference().child("co16 L4");
        r81 = FirebaseDatabase.getInstance().getReference().child("co17 L4");r91 = FirebaseDatabase.getInstance().getReference().child("co18 L4");
        r92 = FirebaseDatabase.getInstance().getReference().child("co19 L4");r93 = FirebaseDatabase.getInstance().getReference().child("co20 L4");
        r94 = FirebaseDatabase.getInstance().getReference().child("co21 L4");
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText( min2table4admin.this,"Table Uploded well",Toast.LENGTH_LONG).show();
