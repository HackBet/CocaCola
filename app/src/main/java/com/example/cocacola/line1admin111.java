...
public class line1admin111 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line1admin111);
        ...
        database = FirebaseDatabase.getInstance().getReference().child("Attendance L1");
        d2 = FirebaseDatabase.getInstance().getReference().child("Safety L1");
        d3 = FirebaseDatabase.getInstance().getReference().child("Previous Day's Action L1");
       // d4 = FirebaseDatabase.getInstance().getReference().child("Review Of Past Performance L1");
        d5 = FirebaseDatabase.getInstance().getReference().child("Today Production plan L1");
        d6 = FirebaseDatabase.getInstance().getReference().child("Today's Action Plan L1");
        d7 = FirebaseDatabase.getInstance().getReference().child("General Communication L1");
        d8 = FirebaseDatabase.getInstance().getReference().child("Issues for escalation L1");
        d9 = FirebaseDatabase.getInstance().getReference().child("Shift L1");
        d10 = FirebaseDatabase.getInstance().getReference().child("Admin Name L1");
