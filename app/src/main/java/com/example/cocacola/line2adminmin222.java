...
public class line2adminmin222 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line2adminmin222);
        ...
        d9 = FirebaseDatabase.getInstance().getReference().child("Shift M2L2");
        d10 = FirebaseDatabase.getInstance().getReference().child("Admin Name M2L2");
        database = FirebaseDatabase.getInstance().getReference().child("Work Practice L2");
        d2 = FirebaseDatabase.getInstance().getReference().child("General Comment L2");
        ...
        bt2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), min2table2admin.class));
            }
        });
