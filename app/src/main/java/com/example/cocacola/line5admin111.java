...
public class line5admin111 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line5admin111);
        ...
        database = FirebaseDatabase.getInstance().getReference().child("Attendance L5");
        d2 = FirebaseDatabase.getInstance().getReference().child("Safety L5");
        d3 = FirebaseDatabase.getInstance().getReference().child("Previous Day's Action L5");
        // d4 = FirebaseDatabase.getInstance().getReference().child("Review Of Past Performance L1");
        d5 = FirebaseDatabase.getInstance().getReference().child("Today Production plan L5");
        d6 = FirebaseDatabase.getInstance().getReference().child("Today's Action Plan L5");
        d7 = FirebaseDatabase.getInstance().getReference().child("General Communication L5");
        d8 = FirebaseDatabase.getInstance().getReference().child("Issues for escalation L5");
        d9 = FirebaseDatabase.getInstance().getReference().child("Shift L5");
        d10 = FirebaseDatabase.getInstance().getReference().child("Admin Name L5");
...
// et4 = (EditText)findViewById(R.id.b40);
        ...
        bt4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),line5admintable111.class));
            }
        });
       /* bt4.setOnClickListener(new View.OnClickListener() {
            @Override
