...
public class line2admin333 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line2admin333);
        ...
        d34 = FirebaseDatabase.getInstance().getReference("Production Plan L2");
        d44 = FirebaseDatabase.getInstance().getReference("Quality Deviations L2");
        d54 = FirebaseDatabase.getInstance().getReference("Accidents, Incidents L2");
        d64 = FirebaseDatabase.getInstance().getReference("Absenteeism L2");
        d74 = FirebaseDatabase.getInstance().getReference("Stoppage Sheets Collected L2");
        d84 = FirebaseDatabase.getInstance().getReference("Actual Captured L2");
        d94 = FirebaseDatabase.getInstance().getReference(" Feedback L2");
        d10 =FirebaseDatabase.getInstance().getReference("Shift L2");
        d12 =FirebaseDatabase.getInstance().getReference("Admin Name L2");
