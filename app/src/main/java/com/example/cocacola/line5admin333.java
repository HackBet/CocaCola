...
public class line5admin333 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line5admin333);
        ...
        d34 = FirebaseDatabase.getInstance().getReference("Production Plan L5");
        d44 = FirebaseDatabase.getInstance().getReference("Quality Deviations L5");
        d54 = FirebaseDatabase.getInstance().getReference("Accidents, Incidents L5");
        d64 = FirebaseDatabase.getInstance().getReference("Absenteeism L5");
        d74 = FirebaseDatabase.getInstance().getReference("Stoppage Sheets Collected L5");
        d84 = FirebaseDatabase.getInstance().getReference("Actual Captured L5");
        d94 = FirebaseDatabase.getInstance().getReference(" Feedback L5");
        d10 =FirebaseDatabase.getInstance().getReference("Shift L5");
        d12 =FirebaseDatabase.getInstance().getReference("Admin Name L5");
