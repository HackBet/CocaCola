...
public class line3admintable111 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line3admintable111);
        ...
        r10 = FirebaseDatabase.getInstance().getReference().child("firstrow L3");
        r20 = FirebaseDatabase.getInstance().getReference().child("secondrow L3");
        r30 = FirebaseDatabase.getInstance().getReference().child("thirdrow L3");;
        r40 = FirebaseDatabase.getInstance().getReference().child("forthrow L3");
        r50 = FirebaseDatabase.getInstance().getReference().child("fifthrow L3");
        r60 = FirebaseDatabase.getInstance().getReference().child("Sixthrow L3");
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(line3admintable111.this,"Table Uploded well",Toast.LENGTH_LONG).show();
            }
        });
